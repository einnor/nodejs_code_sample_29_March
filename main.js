	...
	var output =  '<!DOCTYPE html>' +
								'<html lang="en">'+
									...
									'<body>'+
										...
										'<label>Age:</label>' + '<span style="margin-left:150px;">' + _get['age'] + '</span><br /><br />'+
										'<label>Timestamp:</label>' + '<span style="margin-left:100px;">' + Date.now() + '</span><br /><br />'+
									'</body>'+
								'</html>';
...
const server = http.createServer(onRequest).listen(8080); // Listen on the 8080 port.
